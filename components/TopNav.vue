  ...
  <div id="TopNav" class="fixed bg-white z-30 flex items-center w-full border-b h-[61px]">
    <div class="flex items-center justify-between w-full px-6 mx-auto"
      ...
      <div class="hidden md:flex items-center bg-[#F1F1F2] p-1 rounded-full max-w-[380px]  w-full">
        <input type="text" class=" w-full pl-3 my-2 bg-transparent placeholder-[#838383] text-[15px]
         focus:outline-none" placeholder="Search accounts">
      ...
      <div class="flex item-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
        ...
        <div class="flex items-center">
          <Icon class="ml-1 mr-4" name="carbon:send-alt" color="#161724" size="27"></Icon>
